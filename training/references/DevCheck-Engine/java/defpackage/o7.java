...
public final class o7 {
    ...
    public final int c(RectF rectF) {
        ...
        if (length == 0) {
            c.n("No available text sizes to choose from.");
            return 0;
        }
        int i = length - 1;
        int i2 = 0;
        ...
        while (true) {
            ...
            StaticLayout a2 = k7.a(charSequence, (Layout.Alignment) obj, Math.round(rectF.right), maxLines, this.i, this.h, this.k);
