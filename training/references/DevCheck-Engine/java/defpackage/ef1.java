...
public abstract class ef1 {
    ...
    public static String c(Field field) {
        return field.getDeclaringClass().getName() + bOxzFZXgEkjph.yqzxS + field.getName();
    }
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder w = d51.w(bOxzFZXgEkjph.GJOiYx, d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            w.append(e(e));
