...
public class ix0 extends x5 implements Menu {
    public final MenuBuilder c;

    public ix0(Context context, MenuBuilder menuBuilder) {
        super(context);
        if (menuBuilder != null) {
            this.c = menuBuilder;
        } else {
            c.m("Wrapped Object can not be null.");
            throw null;
        }
    }
    ...
    public final void removeGroup(int i) {
        if (((yo1) this.b) != null) {
            ...
            while (true) {
                ...
                if (((bt1) yo1Var.f(i2)).getGroupId() == i) {
                    ((yo1) this.b).g(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (((yo1) this.b) != null) {
            ...
            while (true) {
                ...
                if (((bt1) yo1Var.f(i2)).getItemId() == i) {
                    ((yo1) this.b).g(i2);
                    break;
                }
                i2++;
