...
public abstract class gn2 {
    ...
    */
    public static int b(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gn2.b(java.lang.String, byte[], int, int):int");
    }
    ...
    */
    public static boolean d(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gn2.d(byte[], int, int):boolean");
    }
}
