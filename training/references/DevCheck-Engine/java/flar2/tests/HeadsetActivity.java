...
public class HeadsetActivity extends a5 {
    ...
    public final boolean B() {
        for (AudioDeviceInfo audioDeviceInfo : this.N.getDevices(2)) {
            if (audioDeviceInfo.getType() == 4 || audioDeviceInfo.getType() == 22 || audioDeviceInfo.getType() == 3) {
                return true;
            }
        }
        return false;
    ...
    public final void C() {
        ...
        this.F.setOnCompletionListener(new vi0(this, 0));
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        final int i = 1;
        r.j0(true);
        r().m0(getResources().getString(R.string.headset));
        this.R = new IntentFilter("android.intent.action.HEADSET_PLUG");
        this.Q = new w5(13, this);
        final int i2 = 0;
        ...
        ((Button) findViewById(R.id.success)).setOnClickListener(new View.OnClickListener(this) { // from class: wi0
            public final /* synthetic */ HeadsetActivity h;
            ...
            public final void onClick(View view) {
                ...
                HeadsetActivity headsetActivity = this.h;
                switch (i3) {
                    case 0:
                        int i4 = HeadsetActivity.S;
                        sharedPreferences2.edit().putBoolean(headsetActivity.getString(R.string.headset), true).commit();
                        headsetActivity.finish();
                        break;
                    default:
                        int i5 = HeadsetActivity.S;
                        sharedPreferences2.edit().putBoolean(headsetActivity.getString(R.string.headset), false).commit();
                        headsetActivity.finish();
                        break;
                }
            }
        });
        ((Button) findViewById(R.id.fail)).setOnClickListener(new View.OnClickListener(this) { // from class: wi0
            public final /* synthetic */ HeadsetActivity h;
        ...
        this.P = button;
        button.setOnClickListener(new tc(12, this));
        AudioManager audioManager = (AudioManager) getSystemService(UQdsoaJMID.yRuDmoSsIPsUSX);
        this.N = audioManager;
        int streamVolume = audioManager.getStreamVolume(3);
        this.M = streamVolume;
        if (streamVolume < 5) {
            this.N.setStreamVolume(3, 5, 0);
        }
        ...
        String b = a2.b();
        if (b != null) {
            ((sj) grVar.t(a2, "androidx.lifecycle.ViewModelProvider.DefaultKey:".concat(b))).c().e(this, new nc(14, this));
        } else {
