...
public class OpenGLInfoActivity extends a5 implements nz0, d01 {
    ...
    public final void d(String str) {
        String str2;
        if (str.equals(getString(R.string.gl_all_extensions)) || str.equals("All extensions")) {
            ...
            j3Var.s = inflate;
            j3Var.n = true;
            th2Var.j(getString(R.string.okay), new qf(10, this));
            ...
            try {
                ((TextView) inflate.findViewById(R.id.info_title)).setText(getString(R.string.gl_all_extensions));
    ...
    public final void onCreate(Bundle bundle) {
        ...
        collapsingToolbarLayout.setTitle(getString(R.string.opengl_analysis));
        ...
        vq a2 = af1.a(a51.class);
        String b = a2.b();
        if (b == null) {
            c.m("Local and anonymous classes can not be ViewModels");
            return;
        }
        a51 a51Var = (a51) grVar.t(a2, "androidx.lifecycle.ViewModelProvider.DefaultKey:".concat(b));
        this.I = a51Var;
        if (a51Var.d == null) {
            a51Var.d = new qy0();
        }
        ...
        qy0Var.e(this, new nc(19, l01Var2));
        a51 a51Var2 = this.I;
        a51Var2.c.execute(new r60(10, a51Var2));
    }
